...
public class FXMLController extends Application {
    ...
    @FXML
     public void openHamburger(EventHandler event) throws IOException {

     if(visibleHamburgerMenu == false)
     {
        hamburgerMenuPane.setVisible(true);
        visibleHamburgerMenu = true;
        System.out.println(visibleHamburgerMenu);
     }
     else if(visibleHamburgerMenu == true)
     {
